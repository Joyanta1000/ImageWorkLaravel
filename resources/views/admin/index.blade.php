                            ...
                            <ul class="docListWindow small-slimscroll-style">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user1.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user2.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user3.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user4.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user5.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="prog-avatar">
                                                <img src="{{asset('/')}}assets/admin/assets/img/user/user6.jpg" alt="" width="40" height="40">
                                            </div>
                                            <div class="details">
                                                <div class="title">
