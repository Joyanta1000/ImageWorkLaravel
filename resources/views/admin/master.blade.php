...
<head>
	...
	<!-- icons -->
    <link href="{{asset('/')}}assets/admin/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
	...
	<!-- morris chart -->
    <link href="{{asset('/')}}assets/admin/assets/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                    <img alt="" src="{{asset('/')}}assets/admin/assets/img/logo.png">
                                ...
                                <li>
                                    <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('/')}}assets/admin/assets/img/user/user2.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('/')}}assets/admin/assets/img/user/user3.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('/')}}assets/admin/assets/img/user/user1.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('/')}}assets/admin/assets/img/user/user8.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('/')}}assets/admin/assets/img/user/user5.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
 				...
 				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
	                <div id="remove-scroll">
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <li class="nav-item">
	                            <a href="{{route('hotel-link')}}" class="nav-link nav-toggle">
	                                <i class="material-icons">email</i>
	                                <span class="title">Hotel Link</span>
                        	...
                        	<div class="chat-sidebar-list">
	                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user3.jpg" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user1.jpg" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user5.jpg" width="35" height="35" alt="...">
	                                        <i class="away dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user4.jpg" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user2.jpg" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user7.jpg" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user6.jpg" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user8.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user9.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{asset('/')}}assets/admin/assets/img/user/user10.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{asset('/')}}assets/admin/assets/img/dp.jpg" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="{{asset('/')}}assets/admin/assets/img/user/user5.jpg" />
                                            <div class="message">
    ...
    <script src="{{asset('/')}}assets/admin/assets/js/pages/chart/morris/morris_home_data.js" ></script>
    <!-- end js include path -->
  </body>
</html>